...
| **丘脑** | `cerebrum/limbic_system/thalamus.py` | [待实现] 感觉中继/门控 |
...
v4.0 根目录保留原始文件名作为向后兼容的 re-export 层。`python main.py` 和 `python main_dialogue.py` 仍可直接运行。
