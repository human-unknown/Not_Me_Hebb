...
7. **跨模态模型需重训**: D=330→372 布局变更导致已保存的 .pkl 模型不兼容, 需运行 `stage2_crossmodal.py` 重新训练
...
| 参数 | 值 |
|------|-----|
| 感知维度 D | **372** (V5 M/P/K×脑区, v5.1 全局切换) |
| 感觉核心 S_CORE | **362** (D - 10, F_context + action_onehot) |
| 隐状态 H | 16 |
| 最大簇数 K | 256 |
